...
C Compute smoothed reference spectrum with narrow lines (birdies)
C removed
      do i=4,nbins-3
         rmax=-1.e10
         ...
         ref2(i)=sum/nsum
      enddo
C Copy smoothed ref back into ref
      call move(ref2(4),ref(4),nbins-6)
C Get median in-band level
      call pctile(ref(4),ref2,nbins-6,50,xmedian)
