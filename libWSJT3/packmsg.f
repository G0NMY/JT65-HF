...
C  See if it's a CQ message, that is 'CQ ' or 'CQ ###' [### 000 ... 999]
...
C ia defines start of first word beyond CQ or CQ ###.
C c1 is the 'word'  Should be a callsign in a formatted msg.
...
C ib defines start of second word
C c2 is the 'word'
...
C ic defines start of third word
C c3 is the 'word'
