...
type
  ...
  TForm8 = class(TForm )
    ...
    procedure srChart1DblClick (Sender : TObject );
    procedure srChartDblClick (Sender : TObject );
  private
...
procedure TForm8.srChart1DblClick(Sender : TObject);
begin
end;

procedure TForm8.srChartDblClick(Sender : TObject);
begin
end;
